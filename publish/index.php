...
if
    (
        ( $browser->getBrowser() == Browser::BROWSER_CHROME && $browser->getVersion() >= 18 ) ||
        ( $browser->getBrowser() == Browser::BROWSER_FIREFOX && $browser->getVersion() >= 11 ) ||
        ( $browser->getBrowser() == Browser::BROWSER_OPERA && $browser->getVersion() >= 11.62 ) ||
        ( $browser->getBrowser() == Browser::BROWSER_IE && $browser->getVersion() >= 9 )

    )
    {
    header( 'Location: main.xhtml' ) ;
    }
else
    {
    ?>
    ...
    <body>
    <?php
    echo 'You have FireFox version 2 or greater<br />';
    echo '<iframe src="old/index.html"></iframe>'; 
    ?>
    </body>
    </html>
    <?php
